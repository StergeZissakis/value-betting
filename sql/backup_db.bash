...
pg_dump --data-only --blobs --create --encoding=UTF-8 --file=data.sql --format=plain --no-owner --superuser=postgres --verbose --dbname=postgres --port=5432 --username=postgres 
